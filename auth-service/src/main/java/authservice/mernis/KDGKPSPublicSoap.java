...
public class KDGKPSPublicSoap
{
    ...
    public KDGKPSPublicSoap(){}

    public KDGKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public KDGKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        KDGExtendedSoapSerializationEnvelope envelope= new KDGExtendedSoapSerializationEnvelope(KDGExtendedSoapSerializationEnvelope.VER11);
